...
export function ContentDocumentDialog({
  ...
  return (
    <div className="fixed inset-0 z-[10000] flex items-end bg-black/25 backdrop-blur-[2px] animate-fade-in sm:items-center sm:justify-center" role="dialog" aria-modal="true">
      ...
      <div ref={dialogRef} tabIndex={-1} className="relative max-h-[88dvh] w-full overflow-hidden rounded-t-[28px] border border-border/60 bg-card shadow-soft outline-none animate-fade-in sm:max-w-3xl sm:rounded-[var(--floating-panel-radius)]">
