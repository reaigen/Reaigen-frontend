    ...
    <label className={cn("relative block min-w-0", className)}>
      ...
      <input
        ...
        className={cn(
          ...
          toolbar
            ? "h-11 border-0 bg-transparent pl-6 pr-8 text-[16px] placeholder:text-muted-foreground/80 focus-visible:placeholder:text-muted-foreground sm:text-[14px] md:h-10"
            : navbar
