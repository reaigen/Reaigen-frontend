                ...
                <div className="mt-3 flex items-center justify-center gap-2">
                  {onCancel && cancelLabel ? (
                    <button
                      ...
                      onClick={onCancel}
                      className={cn(
                        "min-h-9 rounded-xl border px-3 text-[11px] font-medium focus-visible:outline-none focus-visible:ring-2",
                        tone === "dark"
                  ...
                  {onRetry && retryLabel ? (
                    <button
                      ...
                      onClick={onRetry}
                      className={cn(
                        "min-h-9 rounded-xl px-3 text-[11px] font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2",
                        tone === "dark"
