      ...
      <div className="relative mx-auto w-full max-w-[980px] pb-28 md:pb-12">
        ...
        <div className="space-y-6 lg:space-y-8">
          ...
          <section className={cn("min-w-0", !hasMedia && "max-w-3xl")}>
            ...
            <div className="mt-6 hidden border-t border-border/70 pt-5 lg:flex">
              <div
                className="inline-flex max-w-full items-center rounded-full border border-border/70 bg-card p-1 shadow-control"
              >
