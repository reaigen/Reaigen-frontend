...
export default function TourPage({
  ...
  useEffect(() => {
    // Thumbnail derivatives are generated by explicit workspace saves. Never
    // borrow the live million-splat camera during an interactive tour load;
    // that pauses rendering and makes mouse/WASD input appear dead.
